      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed left-1/2 top-1/2 z-[60] w-[90%] ${maxWidthClass} -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-3xl bg-white p-6 shadow-2xl dark:bg-zinc-900`}
          >
