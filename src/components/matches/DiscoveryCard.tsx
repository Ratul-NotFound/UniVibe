  ...
  return (
    ...
    >
       ...
       <div className="p-8 flex flex-col h-full">
          ...
          <div className="relative mb-8 cursor-pointer overflow-hidden rounded-[1.5rem]" onClick={() => onViewProfile(user)}>
             <div className="h-48 w-full bg-zinc-800 border border-white/5 relative">
                {user.photoURL ? (
          ...
          <div className="flex-1 space-y-6">
             <div>
                <h3 className="text-2xl font-black italic uppercase tracking-tighter text-white leading-none mb-2">
                   {user.name}
                </h3>
